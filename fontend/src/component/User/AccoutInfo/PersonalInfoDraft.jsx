      ...
      <div className="personal-0">
        <div className="personal-1">
          ...
          <span>
            ジョブ<b>J</b>
            <span>oinJapa</span>
            への登録は、こちらのエントリーフォームからお願いします。
          </span>
        </div>
        <form onSubmit={(e) => hanldeSubmit(e, onSubmit)}>
          <div className="ho-ten">
            <label>
              姓<input type="text" onChange={(e) => setHo(e.target.value)} />
            </label>
            <label>
              名<input type="text" onChange={(e) => setTen(e.target.value)} />
            </label>
          </div>
          ...
          <div className="bac-hoc-cao-nhat">
            <select
              name=""
              id=""
              onChange={(e) => setBacHocCaoNhat(e.target.value)}
            >
              最終学歴を選択して下さい
          ...
          <div className="gui-CV">
            ...
            <label>
              Word,
              PDF,エクセル,パワーポイントのファイルがアップロード可能です。
              一つファイル2MBまでとなっております。
            </label>
          </div>
          ...
          <div className="cam-ket">
            <label>
              利用規約と個人情報保護方針をお読み頂き、同意の上ご登録下さい
            </label>
            <label>
              <input type="checkbox" onChange={() => handleCheck1("dong y")} />
              <i></i> 利用規約
            </label>
            <label>
              <input type="checkbox" onChange={() => handleCheck2("dong y")} />
              <i></i> 個人情報保護方針
            </label>
          </div>
...
export default PersonalInfoDraft;
